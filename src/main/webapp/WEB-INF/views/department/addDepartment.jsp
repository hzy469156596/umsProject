...
<body>
        <div class="content">
            ...
            <div class="content-form">
                <table>
                    <label>名　称：</label>
                    <input class="input" type="text" name="department.username" placeholder="请输入部门名称" minlength="4" maxlength="25" required>
                    <br>
                    <br>
                    <br>
                    <label>描　述：</label>
                    <textarea name="department.description" rows="10" cols="50" style="vertical-align:top" style="width:40%; height:50%;" placeholder="请输入部门描述" required></textarea>
